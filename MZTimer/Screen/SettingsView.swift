        ...
        VStack(alignment:.center) {
            ScrollView(showsIndicators: false) {
                ...
                VStack(alignment: .leading, spacing: 0 ){
                    ...
                    Text("When event time is less than minimum time, record will be ignored").font(.caption)
                }
                .padding()
                ...
                VStack(alignment:.leading, spacing:0){
                    ...
                    Text("If all receiver is using iMessage, message will send by creating group chat!").font(.caption)
                }
                .padding()
                .border(Color.gray, width: /*@START_MENU_TOKEN@*/1/*@END_MENU_TOKEN@*/)
            ...
            Button(action: {
                if userName.isEmpty || userName == "" {
                    ...
                    UserDefaults.standard.setValue(minimumTime, forKey: "MinimumTime")
                    showSetting.toggle()
                }
            }, label: {
                Text("Save")
